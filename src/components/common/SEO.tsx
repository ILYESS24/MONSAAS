...
export const seoConfigs = {
  ...
  pricing: {
    title: 'Tarifs et Abonnements - Choisissez Votre Plan',
    description: 'Tarifs transparents Aurion Studio : Free, Starter (19€/mois), Pro (49€/mois), Enterprise (199€/mois). 2 mois offerts sur l\'abonnement annuel. Garantie 30 jours.',
    keywords: [
      'tarifs Aurion Studio',
      'prix abonnement SaaS',
      'plans développeurs',
      'offre entreprise',
      'essai gratuit',
      'pricing SaaS',
    ...
    structuredData: {
      ...
      '@type': 'Product',
      name: 'Aurion Studio',
      description: 'Plateforme SaaS de développement avec IA',
      brand: {
        '@type': 'Brand',
        name: 'Aurion Studio',
      },
