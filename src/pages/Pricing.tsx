...
const PRICING_PLANS: PricingPlan[] = [
  {
    id: 'free',
    name: 'Découverte',
    description: 'Idéal pour explorer et tester',
    price: {
      monthly: 0,
      yearly: 0,
    },
    ...
    features: [
      { name: '2 projets actifs', included: true },
      { name: '500 Mo de stockage', included: true },
      { name: 'Code Editor (mode lecture seule)', included: true },
      { name: 'Text Editor basique', included: true },
      { name: 'Intelligent Canvas (3 boards)', included: true },
      { name: 'Aurion Chat (10 msg/jour)', included: true, limit: '10 msg/jour' },
      { name: 'Agent AI', included: false },
      { name: 'App Builder', included: false },
      { name: 'Workflow Automation', included: false },
      { name: 'Export & partage', included: false },
    ],
  },
  {
    id: 'creator',
    name: 'Creator',
    description: 'Pour créateurs indépendants & freelances',
    price: {
      monthly: 12,
      yearly: 97,
    },
    ...
    features: [
      ...
      { name: 'Code Editor complet + AI autocomplete', included: true, highlight: true },
      { name: 'Text Editor avancé + templates', included: true },
      { name: 'Intelligent Canvas illimité', included: true },
      { name: 'Aurion Chat (100 msg/jour)', included: true, limit: '100 msg/jour' },
      { name: 'Agent AI', included: true, limit: '50 requêtes/mois', highlight: true },
      { name: 'App Builder (prototypes)', included: true },
  ...
  },
  {
    id: 'pro',
    name: 'Pro',
    description: 'Pour équipes et professionnels exigeants',
    price: {
      monthly: 39,
      yearly: 349,
    },
    icon: Crown,
    popular: true,
    badge: '⚡ Choix de 73% des utilisateurs',
    buttonText: 'Essai Gratuit 14 jours',
    buttonVariant: 'premium',
    features: [
      { name: 'Projets illimités', included: true, highlight: true },
      { name: '50 Go de stockage', included: true },
      { name: 'Code Editor Pro + GitHub Sync', included: true, highlight: true },
      { name: 'Text Editor + collaboration temps réel', included: true },
      { name: 'Intelligent Canvas + widgets avancés', included: true },
      { name: 'Aurion Chat illimité + mémoire contexte', included: true, highlight: true },
      { name: 'Agent AI', included: true, limit: '500 requêtes/mois', highlight: true },
      { name: 'App Builder complet + déploiement', included: true },
      { name: 'Workflow Automation (10 workflows)', included: true, highlight: true },
  ...
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
    description: 'Solution sur-mesure pour organisations',
    price: {
      monthly: 149,
      yearly: 1290,
    },
    ...
    buttonVariant: 'default',
    badge: 'SLA 99.9% garanti',
    features: [
      { name: 'Tout illimité (projets, stockage)', included: true, highlight: true },
      { name: 'Code Editor + audit sécurité code', included: true },
      { name: 'Tous les outils sans restriction', included: true },
      { name: 'Agent AI illimité + fine-tuning', included: true, highlight: true },
      { name: 'Workflow Automation illimité', included: true },
      { name: 'Monitoring multi-environnement', included: true },
      { name: 'SSO / SAML / SCIM', included: true, highlight: true },
      { name: 'Rôles & permissions avancés', included: true },
      { name: 'Account Manager dédié', included: true },
      { name: 'Formation équipe incluse', included: true },
      { name: 'Déploiement on-premise/cloud privé', included: true },
    ],
  },
];
